                  ...
                  <div className="flex flex-col gap-4  min-h-[25vh]">
                    ...
                    <div className="flex flex-col gap-4 rounded-lg ">
                      {data?.map((gitProvider, _index) => {
                        ...
                        // Use backend-computed requirements
                        const haveGithubRequirements =
                          isGithub && gitProvider.hasRequirements

                        const haveGitlabRequirements =
                          isGitlab && gitProvider.hasRequirements

                        const haveBitbucketRequirements =
                          isBitbucket && gitProvider.hasRequirements

                        const haveGiteaRequirements =
                          isGitea && gitProvider.hasRequirements
